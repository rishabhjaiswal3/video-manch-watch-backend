...
exports.r2Service = {
     ...
     */
    async getUploadPresignedUrl(userId, videoId, filename, contentType, userType = 'user') {
        ...
        console.log(`[R2] 📂 Bucket: ${r2_js_1.R2_BUCKETS.RAW}, Key: ${key}`);
        const command = new client_s3_1.PutObjectCommand({
            Bucket: r2_js_1.R2_BUCKETS.RAW,
            Key: key,
