export declare class UploadService {
    ...
    getStatus(userId: string, videoId: string): Promise<{
        ...
        jobStatus: {
            ...
            data: import("../../../services/queueService.js").TranscodeJobData;
            failedReason: string;
            processedOn: number | undefined;
            finishedOn: number | undefined;
        } | null;
        outputs: import("../../../models/Video.js").IVideoOutput[];
    ...
    listCreatorVideos(userId: string, params: {
        ...
        videos: {
            ...
            outputs: import("mongoose").FlattenMaps<import("../../../models/Video.js").IVideoOutput>[];
